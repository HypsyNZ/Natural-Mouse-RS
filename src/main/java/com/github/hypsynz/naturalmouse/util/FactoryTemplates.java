...
import com.github.hypsynz.naturalmouse.api.SpeedManager;
import com.github.hypsynz.naturalmouse.support.DefaultMouseMotionNature;
import com.github.hypsynz.naturalmouse.support.DefaultNoiseProvider;
import com.github.hypsynz.naturalmouse.support.DefaultOvershootManager;
import com.github.hypsynz.naturalmouse.support.DefaultSpeedManager;
import com.github.hypsynz.naturalmouse.support.DoublePoint;
import com.github.hypsynz.naturalmouse.support.Flow;
import com.github.hypsynz.naturalmouse.support.SinusoidalDeviationProvider;
...
public class FactoryTemplates {
    ...
    public static MouseMotionFactory rs() {
        MouseMotionFactory factory = new MouseMotionFactory();
        List<Flow> flows = new ArrayList<>(Arrays.asList(
                new Flow(FlowTemplates.randomFlowLow()),
                new Flow(FlowTemplates.randomFlowHigh()),
                new Flow(FlowTemplates.randomFlowWide()),
        ...
        factory.getNature().setReactionTimeBaseMs(20);
        factory.getNature().setReactionTimeVariationMs(20);
    ...
    public static MouseMotionFactory rsf() {
        MouseMotionFactory factory = new MouseMotionFactory();
        List<Flow> flows = new ArrayList<>(Arrays.asList(
                new Flow(FlowTemplates.randomFlowLow()),
                new Flow(FlowTemplates.randomFlowLowest()),
                new Flow(FlowTemplates.slowStartupFlow()),
                new Flow(FlowTemplates.slowStartup2Flow()),
                new Flow(FlowTemplates.jaggedFlow()),
                new Flow(FlowTemplates.stoppingFlow())
        ...
        factory.setDeviationProvider(new SinusoidalDeviationProvider(SinusoidalDeviationProvider.DEFAULT_SLOPE_DIVIDER));
        factory.setNoiseProvider(new DefaultNoiseProvider(DefaultNoiseProvider.DEFAULT_NOISINESS_DIVIDER));
        manager.setMouseMovementBaseTimeMs(125);
        factory.getNature().setReactionTimeBaseMs(20);
        factory.getNature().setReactionTimeVariationMs(20);
